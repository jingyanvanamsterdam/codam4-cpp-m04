...
/*                                                   +#+                      */
/*   Created: 2026/07/13 16:44:22 by jdong         #+#    #+#                 */
/*   Updated: 2026/07/13 16:44:23 by jdong         ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
{
	{
		...
		const AAnimal* dog_copy = new Dog(*dog);
		std::cout << "\n";
	...
	{
		//AAnimal* Aanimalinstptr = new AAnimal();
		//AAnimal animalinst
	}
}